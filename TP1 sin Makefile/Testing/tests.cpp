...
void writeFileEj3(){										// este test genera para todo n entre 1 y 100, un total de 80 casos aleatorios de longitud n + 10 ordenados crec + 10 ordenados decrec
	...
	for(int n = 1; n < 251; n++){						// genera 50 casos para n entre 1 y 200 random
	...
	for(int y = 1; y < 251; y++){					// genera 10 casos para n entre 1 y 200, ordenados creciente
		int prim = 0;
		for(int h = 0; h < 10; h++){
			e << y << endl;
	...
	for(int y = 1; y < 251; y++){					// genera 10 casos para n entre 1 y 200, ordenados decreciente
		int prim = 9;
		for(int h = 0; h < 10; h++){
			e << y << endl;
	...
	for(int y = 1; y < 251; y++){					// genera 10 casos para n entre 1 y 200, MayMenMayMen
		int prim = 500;
		for(int h = 0; h < 10; h++){
			e << y << endl;
			int i = 1;
	...
	for(int y = 1; y < 251; y++){				// genera 10 casos para n entre 1 y 200 con números todos iguales
		for(int h = 0; h < 10; h++){
			e << y << endl;
			for(int z = 0; z < y; z++){
				if(z < y - 1){
...
void writeFilePeorCasoEj2(){
	fstream e("EntradasPeorCasoEj2.csv", ios::out);
	for(int y = 2; y < 41; y++){
		int pr = 1;
		for(int h = 0; h < 20; h++){
			e << y << endl;
...
void expPeorCasoEj2(){
	writeFilePeorCasoEj2();
	fstream e ("EntradasPeorCasoEj2.csv", ios::in | ios::out);
	fstream s ("salidasEj2TiempoPeorCaso.csv", ios::out);
...
void expEj3ParaTiempo(){
	...
	for(int i = 0; i < (250 * 50 + 250 * 10 + 250 * 10 + 250 * 10 + 250 * 10); i++){
		int n;
		e >> n;
		s << n;
		s << ",";
